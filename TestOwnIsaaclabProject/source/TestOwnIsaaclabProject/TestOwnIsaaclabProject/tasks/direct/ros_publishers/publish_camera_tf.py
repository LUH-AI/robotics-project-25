        ...
        og.Controller.edit(
            ros_camera_graph_path,
            {
                ...
                og.Controller.Keys.SET_VALUES: [
                    ...
                    (
                    "PublishRawTF_base_laser.inputs:topicName",
                        "/tf",
                    ),

                    # base_laser Camera frame
                    (
                        "PublishRawTF_base_laser.inputs:parentFrameId",
                        camera_frame_id,
                    ),
                    (
                        "PublishRawTF_base_laser.inputs:childFrameId",
                        "base_laser",
                    ),
                ...
                og.Controller.Keys.CONNECT: [
                    ...
                    (
                        ros_camera_graph_path + "/OnTick.outputs:tick",
                        "PublishRawTF_base_laser.inputs:execIn",
                    ),
                    ...
                    (
                        ros_camera_graph_path + "/IsaacClock.outputs:simulationTime",
                        "PublishRawTF_base_laser.inputs:timeStamp",
                    ),
